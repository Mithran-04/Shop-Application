...
class Orders with ChangeNotifier{
   ...
   Future<void> fetchAndSetOrders() async {
     final url = Uri.https(
         'shop-application-340f4-default-rtdb.firebaseio.com', '/orders/$userId.json',{'auth':'$authToken'});
   ...
   Future<void> addOrder(List<CartItem> cartProducts, double total) async{
     ...
     _orders.insert(0,
       OrderItem(id: json.decode(response.body)['name'], amount: total, products: cartProducts, dateTime: DateTime.now()),);
